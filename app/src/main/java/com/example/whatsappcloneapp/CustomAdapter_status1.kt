...
class CustomAdapter_status1(private val mList: List<ItemsViewModel_status>,val context: Context) : RecyclerView.Adapter<CustomAdapter_status1.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.circularStatusView.setPortionsCount(3)
        holder.circularStatusView.setPortionsColor(ContextCompat.getColor(context,R.color.colorAccent))
